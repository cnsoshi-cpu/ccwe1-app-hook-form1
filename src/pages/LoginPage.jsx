        ...
        <div className={styles.container}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}className={styles.formCard}>
                ...
                <div className={styles.inputGroup}>
                    ...
                    <input {...register("password")}  className={styles.input} type="password" placeholder="********"/>
                    {
                        errors.password && (<span className={styles.erorrText}>{errors.password.message}</span>)
                    }
                </div>
                ...
                <div className={styles.inputGroup}>
                    ...
                    <input {...register("confirmPassword")}  className={styles.input} type="password" placeholder="********"/>
                    {
                        errors.confirmPassword && (<span className={styles.erorrText}>{errors.confirmPassword.message}</span>)
                    }
                </div>
